...
describe('get /search?query=...', () => {
  test('after running a search on a query, the alreadyAdded property of a book will be set to \'true\' if user already has it saved', async () => {
    const agent = supertest.agent(app);
    ...
    expect(testBook.alreadyAdded).toBe(true);
  });
});
